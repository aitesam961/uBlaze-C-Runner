...
HD_PWD='C:/Users/atsm/Documents/Vivado/uBlaze_ARTY_A7/Hardware_Files/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ARTY_A7_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ARTY_A7_wrapper.tcl -notrace
