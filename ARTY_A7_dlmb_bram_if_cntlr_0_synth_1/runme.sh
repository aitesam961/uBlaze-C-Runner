...
HD_PWD='C:/Users/atsm/Documents/Vivado/uBlaze_ARTY_A7/ARTY_A7_dlmb_bram_if_cntlr_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ARTY_A7_dlmb_bram_if_cntlr_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ARTY_A7_dlmb_bram_if_cntlr_0.tcl
